...
| **USE_TRAEFIK_CERT** | Use the certificate generated by Traefik | *optional* | false
...
To use Let's Encrypt certificates generated by Traefik, switch `USE_TRAEFIK_CERT` environment variable to `true` and mount a new docker volume like this :

```yml
mailserver:
  image: hardware/mailserver
  environment:
    - USE_TRAEFIK_CERT=true
  volumes:
